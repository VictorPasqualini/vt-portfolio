...
- ~~Open to opportunities badge~~ — shipped 2026-09-07. Accent pill with a pulsing dot next to the location line in `components/Hero.tsx`; text lives in `hero.availability` in both content files.
