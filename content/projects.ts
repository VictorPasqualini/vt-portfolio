...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    description: {
      en: "A personal finance dashboard that reads the spreadsheet you already keep on OneDrive. Income and expenses by month, spending by segment and by week, credit card, and a screen just for investments, where contributions don't count as spending and yields don't count as income. No database, no new format: it maps the columns you already use.",
      pt: 'Um dashboard de finanças pessoais que lê a planilha que você já mantém no OneDrive. Receitas e despesas por mês, gastos por categoria e por semana, cartão de crédito, e uma tela só para investimentos, onde aportes não contam como gasto e rendimentos não contam como receita. Sem banco de dados, sem formato novo: ele mapeia as colunas que você já usa.',
    },
  },
  {
    slug: 'pouch',
    name: 'Pouch',
    githubUrl: 'https://github.com/VictorPasqualini/pouch',
    language: 'Python',
